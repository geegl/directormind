...
| Canonical conversion | `PYTHONDONTWRITEBYTECODE=1 python3 skills/drama-director-compiler/scripts/convert_legacy_scene_evidence.py --check` | PASS — 31 scenes, 2,344 Shot/edit units, 124 candidate identities | Proves deterministic output from legacy inputs plus the canonical reviews, including the renewed Chernobyl hard-cut split |
