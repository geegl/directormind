...
| `TED-DARTS` | `足球教练_第一季_2020_EP08_HD1080P_X264_AAC_English_CHS_ENG_BDYS.mp4` | EVIDENCE_COMPLETE_VISUAL_V0.1 / SOUND_UNKNOWN | Verified selected envelope `00:19:24.288–00:26:10.527` end-exclusive (`9740f / 406.239s`), 147 complete visible shots. Picture verifies pub/board/person/object ordering, a 30-shot visibly distinct riverside block, board-first pub return, long person singles and later distributed body/contact states. Game, wager, skill, score, biography, result/reversal, shared stimulus, cross-cut object identity, thread function and sound remain script-gated, INFERRED, or UNKNOWN; see `TED-LASSO-S01E08-DARTS-REVERSAL-001`. |
