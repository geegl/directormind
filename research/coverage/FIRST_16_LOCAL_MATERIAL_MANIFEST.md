...
| `KNIVES-WILL` | `利刃出鞘.mp4` | LOCAL_PRESENT_EXACT_ENVELOPE_VERIFIED / SHOT_TABLE_PENDING | Verified full selected envelope `01:07:10.733–01:12:44.567` end-exclusive (`10015f / 333.833s`): five residence/object/portrait establishment units lead into a recurring multi-person room, which visibly spills through the doorway to exterior/vehicle coverage before the final road cut. Interior core `01:07:19.267–01:11:37.400`. Complete shot count, paper meaning, public-status trigger, relationships, reaction causes, dialogue, sound, and hidden joins remain pending or UNKNOWN. |
