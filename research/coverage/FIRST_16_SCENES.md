...
- Complete every locally available scene without another per-scene approval.
- Keep one missing-material manifest for unavailable scenes; do not substitute synopsis or subtitle evidence for shots.
- A completed scene still produces candidate rules only.
- *Apollo 13* and *Citizen Kane* remain useful second-wave candidates, but they do not replace any of the 16 above.
