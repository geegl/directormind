...
def build_report(live_evidence: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "unverified_boundaries": [
            "THIRTY_FIVE_CANDIDATES_REMAIN_FIXED_CORPUS_EVIDENCE_GAPS",
            "FOUR_CANDIDATES_REQUIRE_DIRECT_AUDITION_OF_EXISTING_MATERIAL",
            "TWENTY_EIGHT_OF_THIRTY_ONE_EVIDENCE_UNITS_HAVE_FINAL_DECISION_MAPPINGS",
            "FOUR_OF_SIXTEEN_FAMILIES_ARE_NOT_YET_RUNTIME_PARTICIPATING",
